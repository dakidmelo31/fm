    ...
    return Stack(
      ...
      children: [
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(170 *
                                      (0.1 +
                                          1 -
                                          widget.completedAnimation.value)),
                                ),
                                child: ListView(
                                                                    ...
                                                                    child: Chip(
                                                                      ...
                                                                      avatar: Icon(
                                                                          ...
                                                                          color: Colors
                                                                              ...
                                                                              ? _categories.indexOf(cat) - Colors.primaries.length
        ...
        AnimatedBuilder(
            ...
            builder: (_, child) {
              final left = size.width * (1 - _loadingController.value);
              return Positioned(
                  top: 0,
                  left: left,
                  height: size.height,
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: _loadingController.value == 0
                        ? null
                        : Container(
                            width: double.infinity,
                            height: size.height,
                              ...
                              children: [
                                ...
                                Center(
                                  ...
                                  child: Shimmer(
                                      ...
                                      child: Text("This may take a minute ",
                                          style: TextStyle(fontSize: 22.0))),
                                ))
                              ],
                            ),
